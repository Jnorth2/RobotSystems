...
class Picarx(object):
    ...
    @log_on_start(logging.DEBUG, "Initialize picar improved")
    @log_on_error(logging.DEBUG, "Failed to Initialize picar improved object")
    @log_on_end(logging.DEBUG, "Initialized picar improved successfully")
    def __init__(self, 
    ...
    @log_on_start(logging.DEBUG, "Stopping the robot")
    @log_on_error(logging.DEBUG, "Failed to stop the robot")
    @log_on_end(logging.DEBUG, "Robot stopped successfully")
    def stop(self):
        '''
